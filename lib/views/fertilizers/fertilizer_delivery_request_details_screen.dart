...
class DeliveryRequestDetailsScreen extends StatelessWidget {
  ...
  void _onMarkAsDelivered(BuildContext context, RichFertilizerOrder order) {}
...
Row(
  ...
  children: [
    // Left: Total Amount label and value in one row
    Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text(
    ...
    // Right: Mark as Delivered button (below the amount alignment)
    Column(
      crossAxisAlignment: CrossAxisAlignment.end,
      children: [
        const SizedBox(height: 30), // Aligns button roughly with the amount text vertically
        GestureDetector(
          onTap: () => _onMarkAsDelivered(context, order),
          child: Container(
            padding: const EdgeInsets.symmetric(
