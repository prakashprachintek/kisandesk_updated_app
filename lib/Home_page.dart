...
class _HomePageState extends State<HomePage> {
  ...
  void _onItemTapped(int index) async {
    ...
    // else if (index == 2) { // Handle TransactionPage navigation
    //   Navigator.push(
    //     context,
        ...
        appBar: AppBar(
          ...
          actions: [
            ...
            IconButton(
              ...
              onPressed: () {
                // Add the action for the heart icon here
                print("Heart icon clicked");
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => WeatherPage(userData: widget.userData, phoneNumber:widget.phoneNumber,)),
                );
              },
            ),
            IconButton(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return DashboardCard(
                      ...
                      // }
                        ...
                        Navigator.push(
                          context,
                          MaterialPageRoute(builder: (context) => LabourPage()),
                        );
                      }
                          : index == 4
                          ? () {
        ...
        bottomNavigationBar: BottomNavigationBar(
          ...
          items: <BottomNavigationBarItem>[
            BottomNavigationBarItem(
              ...
              label: tr('Home'), // Use tr function
            ),
            BottomNavigationBarItem(
              icon: Icon(Icons.add),
              label: tr('Add'), // Use tr function
            ),
            // BottomNavigationBarItem(
            //   icon: Icon(Icons.swap_horiz),
            //   label: tr('Transaction'), // Use tr function
            // ),
            BottomNavigationBarItem(
              icon: Icon(Icons.post_add),
              label: tr('Mypost'), // Use tr function
            ),
          ],
        )
